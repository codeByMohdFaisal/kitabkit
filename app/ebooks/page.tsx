...
export const metadata: Metadata = {
  title: "All Guides",
  description:
    "Browse the full catalog of practical implementation-kit ebooks, filterable by category and language.",
    ...
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
      <header className="mb-8 max-w-2xl">
        ...
        <p className="mt-3 text-ink/70">
          Every implementation kit we&rsquo;ve published, in one place. Filter by category
          or language to find the right one for you.
        </p>
      </header>
